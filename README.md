...
- <i class="far fa-book-open"></i> [Merge vs rebase]
- <i class="far fa-book-open"></i> [Mastering git]

### SQL

- <i class="far fa-exclamation"></i> [Installing and setting up PostgreSQL]
- <i class="far fa-exclamation"></i> [Installing psycopg2]
- <i class="far fa-exclamation"></i> [Best practices for Python/Psycopg/Postgres]
...
- <i class="far fa-exclamation"></i> [Flask/Jinja Tips & Tricks]
- <i class="far fa-exclamation"></i> [Passing data from browser]
- [Collection of web resources]
- <i class="far fa-book-open"></i> [Pip and VirtualEnv]
- <i class="far fa-book-open"></i> [A web-framework for Python: Flask]
